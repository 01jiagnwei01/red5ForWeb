...
public class MyContext extends Context{
	public static Logger logger = LoggerFactory.getLogger(MyContext.class);
	 ...
	 * Core context
	 */
	protected BeanFactory coreContext;
	 ...
	 */
	protected IScopeResolver scopeResolver;
	 ...
	 * Persistence store
	 */
	protected IPersistenceStore persistanceStore;
	...
	public MyContext(ApplicationContext context, String contextPath) {
...
//			coreContext = applicationContext.getParentBeanFactory();
			coreContext = applicationContext;
		}
	}
